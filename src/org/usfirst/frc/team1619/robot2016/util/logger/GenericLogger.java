...
public abstract class GenericLogger {
  ...
  private static final int MAX_LOGS = Constants.LOGGER_MAX_LOGS;
  private static final int QUEUE_SIZE = Constants.LOGGER_QUEUE_SIZE;
  private static final String LOG_FOLDER_PATH = Constants.LOGGER_LOG_FOLDER_PATH;
