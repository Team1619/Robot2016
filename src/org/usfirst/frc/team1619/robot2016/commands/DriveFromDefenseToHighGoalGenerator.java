...
public enum DriveFromDefenseToHighGoalGenerator {
  ...
  public CommandSequence getDriveToTargetGoalSequence(
    ...
    double relativeYPosition =
      (yCoordinate - yPositionOffset) - targetPosition.getTargetYCoordinate();
    ...
    driveSequence.add(
      new DriveRotateCommand(angle - sensorInput.getNavXHeading(), 1.0, 2000));
    driveSequence.add(new DriveTranslateCommand(straightDistance, 1.0, 5.0, 2000));
